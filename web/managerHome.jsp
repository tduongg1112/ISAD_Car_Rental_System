...
<body>
    ...
    <div class="card">
        ...
        <form action="searchCar.jsp" method="get">
            <button class="action-btn primary" type="submit">Manage Car</button>
        </form>
        ...
        <form action="selectStat.jsp" method="get">
            <button class="action-btn secondary" type="submit">Statistics</button>
        </form>
